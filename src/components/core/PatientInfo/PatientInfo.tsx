    ...
    <PatientInfoStyles>
      ...
      <Section name="patient" SectionImage={HeartIcon} align="left">
        ...
        <p className="info-box">
          Data urodzenia: <span>{birthday}</span>
        </p>
        <p className="info-box">
          Grupa krwi <span>{bloodType}</span>
        </p>
        <p className="info-box">
          Telefon do opiekuna: <br />
          <span>{contactTelephone}</span>
        </p>
        <p className="list-box">Opis: </p>
